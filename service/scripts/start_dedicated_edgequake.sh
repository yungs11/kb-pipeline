...
nohup env \
  ...
  EDGEQUAKE_DEFAULT_LLM_MODEL=qwen/qwen3.5-122b-a10b EDGEQUAKE_LLM_MODEL=qwen/qwen3.5-122b-a10b EDGEQUAKE_LLM_DISABLE_REASONING=1 EDGEQUAKE_EXTRACTION_LANGUAGE=Korean \
